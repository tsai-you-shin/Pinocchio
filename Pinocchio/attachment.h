...
template <class T>
VisibilityTester *makeVisibilityTester(const T *tree) { return new VisTester<T>(tree); } // be sure to delete afterwards
...
public:
    ...
    pair<int, double> getnzWeights(int i, int j) const;
